...
func print_usage_instructions():
	...
	print("• Menu shows available conversations and locked ones with trust requirements")
	print("• Right-click NPCs: Show debug info")
	print("")
	print("TRUST SYSTEM:")
	...
	print("")
	print("TRUST GATES:")
	print("• Quick Chats: No trust required (always available)")
	print("• Topic Discussions: Require Professional trust (1.0+)")
	print("• Deep Conversations: Require Trusted trust (2.0+)")
	print("• Blocked conversations appear greyed out in menu with requirements")
	...
	print("")
	print("ENHANCED UI:")
	print("• Clean NPC display with essential info only")
	print("• Dropdown menu for conversation selection (much more intuitive!)")
	print("• Trust levels and relationship history in conversation window")
	...
	print("1. Click NPCs → Select different conversation types from menu")
	print("2. See trust gates in action (greyed out menu items)")
	print("3. Build trust with Quick Chats → Watch conversations unlock in menu")
	print("4. Use incompatible social approaches → Experience failures")
	print("5. Try different Social DNA builds → See how trust building changes")
	print("6. Have multiple conversations → Watch relationship history develop")
	print("===================================\n")
